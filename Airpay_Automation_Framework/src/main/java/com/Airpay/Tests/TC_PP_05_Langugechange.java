...
public class TC_PP_05_Langugechange extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_PaymentPage_BusinessLogic AirPay_Local = new AirPay_PaymentPage_BusinessLogic(driver, TC_ID);
				AirPay_Local.LocalHostDetailPagewithcurrency();	
				//AirPay_Local.NavigateToLocalHostPage();
				AirPay_Local.Verify_PaymentPagecurrency();
				AirPay_Local.Verify_langugechange();
